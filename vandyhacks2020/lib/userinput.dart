            ...
            children: [
              ...
              ListTile(
                ...
                onTap: () {
                  createAlertDialog(context).then((onValue) {
                    globals.user
                        .changeExpense('Utility', double.parse('onValue'));
                  });
                },
                selected: true,
                title: new Text('Utility',
                    style: TextStyle(fontSize: 20, color: Colors.black)),
              ),
              ListTile(
                dense: true,
                ...
                onTap: () {
                  createAlertDialog(context).then((onValue) {
                    globals.user.changeExpense(
                        'Subscriptions', double.parse('onValue'));
                  });
                },
                selected: true,
              ...
              ListTile(
                ...
                onTap: () {
                  createAlertDialog(context).then((onValue) {
                    globals.user
                        .changeExpense('Bills', double.parse('onValue'));
                  });
                },
                selected: true,
              ...
              ListTile(
                ...
                onTap: () {
                  createAlertDialog(context).then((onValue) {
                    globals.user
                        .changeExpense('Savings', double.parse('onValue'));
                  });
                },
                selected: true,
              ...
              ListTile(
                ...
                onTap: () {
                  createAlertDialog(context).then((onValue) {
                    globals.user
                        .changeExpense('Clothes', double.parse('onValue'));
                  });
                },
                selected: true,
              ...
              ListTile(
                ...
                onTap: () {
                  createAlertDialog(context).then((onValue) {
                    globals.user
                        .changeExpense('Electronics', double.parse('onValue'));
                  });
                },
                selected: true,
              ...
              ListTile(
                ...
                onTap: () {
                  createAlertDialog(context).then((onValue) {
                    globals.user
                        .changeExpense('Other', double.parse('onValue'));
                  });
                },
                selected: true,
            ...
            children: [
              ...
              ListTile(
                ...
                onTap: () {
                  createAlertDialog(context).then((onValue) {
                    globals.user
                        .addIncome('Bi-Weekly', double.parse('onValue'));
                  });
                },
                selected: true,
                title: new Text('Bi-Weekly',
                    style: TextStyle(fontSize: 20, color: Colors.black)),
              ),
              ListTile(
                dense: true,
...
class UserInput {
  ...
  static const lastDefaultExpenses = {
    'Rent': 1.0,
    'Utility': 10.0,
    'Subscriptions': 1.0,
    'Bills': 1.0,
